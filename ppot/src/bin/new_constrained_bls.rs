// Copied from https://github.com/kobigurk/phase2-bn254/blob/master/powersoftau/src/bin/new_constrained.rs
// Modification: change BN254 to BLS12-381
...
fn main() {
    ...
    let parameters = CeremonyParams::<PE>::new(circuit_power, batch_size);
