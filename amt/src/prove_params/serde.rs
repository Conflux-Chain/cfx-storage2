...
impl<PE: Pairing> CanonicalDeserialize for AMTParams<PE> {
    fn deserialize_with_mode<R: ark_serialize::Read>(
        ...
        let high_basis =
            CanonicalDeserialize::deserialize_with_mode(&mut reader, compress, validate)?;
        let high_g2 = CanonicalDeserialize::deserialize_with_mode(&mut reader, compress, validate)?;
        Ok(AMTParams::new(
...
impl<PE: Pairing> ark_serialize::CanonicalSerialize for AMTParams<PE> {
    fn serialize_with_mode<W: ark_serialize::Write>(
        ...
        CanonicalSerialize::serialize_with_mode(&self.high_basis, &mut writer, compress)?;
        CanonicalSerialize::serialize_with_mode(&self.high_g2, &mut writer, compress)?;
        Ok(())
    }
